/* this library is slightly modified by George.  5/25/2004
 * 1. initran() is remarked.
 * 2. modify cluster.c kcluster: 
 *  (1) Add return parameter "cmask". 
 *  (2) Remove memory allocation for "cmask"  
 *  (3) copy "tcmask" to "cmask" when "cdata" replaced by "tcdata"  5/25/2004 
 * 3. modify cluster.c and cluster.h: 
 *  (1) change "static double euclid (int n,..." to "double CALL euclid (int n,...".					
...
double CALL euclid (int n, double** data1, double** data2, int** mask1, int** mask2,
...
/* *********************************************************************** */
// modified by George: adding return parameter "cmask"  5/25/2004
void CALL kcluster (int nclusters, int nrows, int ncolumns,
  double** data, int** mask, double weight[], int transpose,
  int npass, char method, char dist,
  int clusterid[], double** cdata, int** cmask, double* error, int* ifound)
/*
-- kcluster routine --
