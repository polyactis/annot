...
class fim_to_db:
	def __init__(self, infname, dbname, schema, set_connectivity, report, needcommit=0):
...
if __name__ == '__main__':
	...
	try:
		opts, args = getopt.getopt(sys.argv[1:], "hrd:k:nc", ["help", "report", "dbname=", "schema=", "set_connectivity", "commit"])
	except:
		print __doc__
		sys.exit(2)
	...
	if schema and len(args)==1:
		instance = fim_to_db(args[0], dbname, schema, set_connectivity, report, commit)
		instance.submit()
	else:
		print __doc__
		sys.exit(2)
